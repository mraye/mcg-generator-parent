...
public class DefaultJavaTypeResolver implements JavaTypeResolver {

	private ContextHolder contextHolder;


	protected boolean forceBigDecimals;
	protected boolean useJSR310Types=true;
	...
	@Override
	public String calculateJavaPropertyName(IntrospectedColumn introspectedColumn) {
		String answer = null;
		JdbcTypeInformation jdbcTypeInformation = typeMap.get(introspectedColumn.getJdbcType());
		if (jdbcTypeInformation != null) {
			answer = jdbcTypeInformation.getFullyQualifiedJavaType().getBaseShortName();
		}
		return answer;
	}
